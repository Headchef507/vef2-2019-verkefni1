    ...
    if(Array.isArray(children)){
        for (let child of children){
            if (typeof child === 'string'){
                element.appendChild(document.creatTextNode(child));
            }
            else if (child){
      ...
      content.forEach((i) => {
        ...
        switch (i.type) {
          ...
          case 'list':
            ...
            break;
          case 'heading':
            thing = heading(i.data);
            break;
          case 'code':
            thing = code(i.data);
            break;
          case 'quote':
            thing = quote(i.data, i.attribute);
            break;
          case 'image':
            thing = image(i.data, i.caption);
            break;
          default:
            thing = el('div', i.type);
        }
  
        col.appendChild(thing);
      });
